...
public class SyncManager {
    ...
    /**
     * Cr�ation de l'instance du singleton
     * @param p
     *          Port sur lequel le seveur va �couter
     * @param handler
     *          Interface qui va g�re le commande sortante
     */
    ...
    /**
     * Permet de changer le handler en fonction du lecteur utilis�
     * @param handler
     *          Nouveau handler
     */
    ...
    /**
     * Contr�le si on a une connection ouverte
     * @return
    ...
    /**
     * Envoie au client le nom du m�dia que l'on va lire
     * @param mediaName
     *          Nom du m�dia
     */
    ...
    /**
     * Indique au client que l'on a cliqu� sur pause
     */
    public void pause(){
        if(!isConnected()){
            log.log(Level.SEVERE, "[TCP][Client] NOT CONNECTED");
    ...
    /**
     * Indique au client que l'on a cliqu� sur play
     */
    public void play(){
        if(!isConnected()){
            log.log(Level.SEVERE, "[TCP][Client] NOT CONNECTED");
    ...
    /**
     * Indique au client que l'on met le m�dia � N secondes
     * @param second
     *          Nombres de seconde
     */
